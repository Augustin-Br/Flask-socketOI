...
#le joueur 1 est a droite et le joueur 2 est a gauche

"""


class GameProcessus:
    def __init__(self, areaRange=[1000, 1000], defaultSpeed=10, nbRound=8):
        ...
        # initialization raquettes, dimention raquette :( 10 x 100 ) :
    ...
    def isRaquetteTouched(self, newBallPosition):
        ...
        for player in range(2):
            ...
            if(self.raquettePos[player][0][1] >= newBallPosition[0] >= self.raquettePos[player][0][0] and self.raquettePos[player][1][1] >= newBallPosition[1] >= self.raquettePos[player][1][0]):
                ...
                percentage = ( (newBallPosition[1] - self.raquettePos[player][1][0]) / (self.raquettePos[player][1][1] - self.raquettePos[player][1][0]) ) * 2
